...
def intake(req: IntakeRequest):
    ...
    lead_id=save_record('lead', req.customer_name, json_dumps(payload)); return {'id':lead_id, **payload}
@app.get('/api/leads')
def leads():
    return {'leads':[json_loads(r['payload']) | {'id': r['id'], 'created_at': r['created_at']} for r in rows('lead')]}
